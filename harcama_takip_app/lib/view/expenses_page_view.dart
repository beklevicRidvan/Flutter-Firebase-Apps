...
class ExpensesPageView extends StatelessWidget {
  ...
  _buildBody(BuildContext context) {
    ExpansesPageViewModel viewModel = Provider.of<ExpansesPageViewModel>(context, listen: false);
    return Stack(
      children: [
        Image.asset(
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return MyListTile(
                            updateFunc: ()=> viewModel.update(currentElement),
                            deleteFunc:()=> viewModel.delete(currentElement),
                            id: currentElement.cardId,
